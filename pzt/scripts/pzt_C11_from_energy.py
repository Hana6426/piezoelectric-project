#!/usr/bin/env python3
"""
Compute C11 for tetragonal PZT (PbTiO3) from ±0.2% xx strain
...
Assumes these files already exist and are converged:
  ...
  - pzt/elastic_tet/eps_p002_xx.out  (+0.2% strain)
  - pzt/elastic_tet/eps_m002_xx.out  (-0.2% strain)
"""
...
def main():
    ...
    eps_p_file = "pzt/elastic_tet/eps_p002_xx.out"
    eps_m_file = "pzt/elastic_tet/eps_m002_xx.out"

    # Strain magnitude ±0.2% in xx
    eps = 0.002
    ...
    C11_Pa  = d2E_J / (V0_m3 * eps ** 2)
    C11_GPa = C11_Pa / 1.0e9

    print("PZT (tetragonal) C11 from ±0.2% xx strain (energy FD):")
